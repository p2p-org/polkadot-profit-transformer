...
export type ParachainStakingProcessorRestApi = ReturnType<typeof ParachainStakingProcessorRestApi>

export const ParachainStakingProcessorRestApi = (/* deps: { blocksPreloader: BlocksPreloader } */) => {
